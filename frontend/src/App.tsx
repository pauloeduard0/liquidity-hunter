  ...
  const indicatorGroups: IndicatorGroup[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'Counter-trend hunt bands (solid; teal = bull, lilac = bear, amber = live)',
        },
        {
          id: 'cont',
          label: 'Continuation windows',
          glyph: '▨',
          color: '#ffb300',
          active: continuationWindowVisible,
          onToggle: () => setContinuationWindowVisible((v) => !v),
          title: 'Aligned continuation bands (hatched; teal = bull, lilac = bear, amber = live leg)',
        },
        {
          id: 'piso',
          label: 'Piso (defended)',
