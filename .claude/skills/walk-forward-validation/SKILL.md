...
description: Time-series-aware validation for measurement studies in research/ — rolling/expanding walk-forward splits, purged and combinatorial-purged CV with embargo, and overfit detection (deflated Sharpe, PBO). Use ONLY when the user explicitly asks to run or design a backtest, a validation study, or an out-of-sample check; do not invoke it on ordinary code, detector, or frontend work.
---
